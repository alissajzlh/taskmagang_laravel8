...
<!-- Mirrored from themeon.net/nifty/v3.0.1/tables/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Jan 2023 07:36:58 GMT -->
<head>
    <meta http-equiv="content-type" content="text/html; charset=UTF-8">
    <meta name="viewport" content="width=device-width, height=device-height, initial-scale=1">
    <title>Tables | Nifty - Admin Template</title>
        ...
        <section id="content" class="content">
            <div class="content__header content__boxed overlapping">
                <div class="content__wrap">
                    ...
                    <h1 class="page-title mb-0 mt-2">Tables</h1>
                    ...
                    <div class="row">
                            ...
                            <div class="card h-100">
                                <div class="card-body d-flex flex-column">
                                    <div class="card-title">
                                        <a class="h5 btn-link" href="static-tables/index">Static Tables</a>
                                    </div>
                                    <p class="text-muted">A table is an arrangement of information or data, …</p>

                                    <div class="mt-auto">
                                        <a class="btn-link" href="static-tables/index">Read more ></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card h-100">
                                <div class="card-body d-flex flex-column">
                                    <div class="card-title">
                                        <a class="h5 btn-link" href="gridjs/index">Gridjs</a>
                                    </div>
                                    <p class="text-muted">A table library that works everywhere</p>

                                    <div class="mt-auto">
                                        <a class="btn-link" href="gridjs/index">Read more ></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card h-100">
                                <div class="card-body d-flex flex-column">
                                    <div class="card-title">
                                        <a class="h5 btn-link" href="tabulator/index">Tabulator</a>
                                    </div>
                                    <p class="text-muted">Interactive Tables and Data Grids for JavaScript.</p>

                                    <div class="mt-auto">
                                        <a class="btn-link" href="tabulator/index">Read more ></a>
                                    </div>
                                </div>
                            </div>
                        </div>

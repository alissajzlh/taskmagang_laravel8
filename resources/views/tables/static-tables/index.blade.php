...
<!-- Mirrored from themeon.net/nifty/v3.0.1/tables/static-tables/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Jan 2023 07:34:20 GMT -->
<head>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><span class="text-danger fw-bolder">- 28.76%</span></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><span class="text-warning fw-bolder">- 8.55%</span></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><span class="text-success fw-bolder">+ 58.56%</span></td>
                                                </tr>
                                                <tr>
                                                    <td class="text-center"><i class="demo-pli-smartphone-3 fs-1"></i></td>
                                                    <td>
                                                        <span class="h6">Smartphone</span>
                                                        <br>
                                                        <small class="text-muted">Last 7 days : 34,553k</small>
                                                    </td>
                                                    <td class="text-center"><span class="text-success fw-bolder">+ 35.76%</span></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>

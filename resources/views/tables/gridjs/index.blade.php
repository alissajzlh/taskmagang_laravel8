                ...
                <div class="content__wrap">
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <h2>GridJS</h2>
                                <p class="m-0">Grid.js is a Free and open-source JavaScript table plugin. It works with most JavaScript frameworks, including React, Angular, Vue and VanillaJs.</p>
                            </div>
